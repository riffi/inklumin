...
export const BlockEditModal = (props: IBlockEditModalProps) => {
  ...
  const [modalTitleForms, setModalTitleForms] = useState<IBlockTitleForms>(
    props.initialData?.titleForms || {
      ...defaultTitleForms,
      nominative: props.initialData?.title || "",
    }
  );
  ...
  useEffect(() => {
    if (props.isOpen) {
      ...
      setModalTitleForms(
        props.initialData?.titleForms || {
          ...defaultTitleForms,
          nominative: props.initialData?.title || form.values.title || "",
        }
      );
  ...
  useEffect(() => {
    ...
    if (!showApiErrorFields) {
      setModalTitleForms((prev) => ({
        ...(prev || defaultTitleForms),
        nominative: form.values.title || "",
      }));
    }
      ...
      >
        <form onSubmit={form.onSubmit(handleFormSubmit)}>
          ...
          <Group justify="flex-end" mt="xl">
            ...
            <Button type="submit">
              {showApiErrorFields ? "Сохранить с ручным вводом" : "Сохранить"}
            </Button>
          </Group>
        </form>
      </Modal>
