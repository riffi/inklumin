...
import { Avatar, Box, Button, Group, Modal, Stack, Text, UnstyledButton } from "@mantine/core";
  ...
  if (!user) {
    return (
      <>
        ...
        <RegisterModal opened={registerModalOpened} onClose={() => setRegisterModalOpened(false)} />
      </>
    );
  }
  ...
  return (
    <>
      ...
      >
        <Stack>
          <Group>
            <Avatar src={null} radius="xl" color="blue" size="lg">
              <IconUser size={24} />
            </Avatar>
            <div>
              <Text size="lg" fw={500}>
