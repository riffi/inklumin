...
import { IconCloud, IconCloudDownload, IconDownload, IconUpload } from "@tabler/icons-react";
      ...
      <Stack gap="xl">
        ...
        <div>
          ...
          <Text size="sm" mb="md" c="dimmed">
            Экспорт и импорт данных в виде файла. При импорте текущие данные будут полностью
            заменены.
          </Text>
